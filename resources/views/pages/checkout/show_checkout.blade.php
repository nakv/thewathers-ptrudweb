    ...
    <section id="cart_items">
        <div class="row">
            ...
            {{-- <div class="register-req">
                <p style="color: black;">Đăng ký hoặc đăng nhập để thanh toán giỏ hàng và xem lại lịch sử mua hàng.</p>
            </div> --}}
            <!--/register-req-->
                    ...
                    <div>
                        ...
                        <div class="form-one">
                            <form method="POST">
                                ...
                                @endif
                                <input type="hidden" name="order_fee" class="order_fee" value="{{ $ship }}">
