                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                switch ($order->order_status) {
                                    case 1:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đang chờ xác nhận</a>';
                                        break;
                                    case 2:
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đã xác nhận, đang gói hàng</a>';
                                        break;
                                    case 10:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đã thanh toán, đang gói hàng</a>';
                                        break;
                                    case 5:
                                    case 11:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đang vận chuyển</a>';
                                        break;
                                    case 6:
                                    case 12:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đã nhận hàng</a>';
                                        break;
                                    case 7:
                                    case 13:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đã hủy đơn</a>';
                                        break;
                                    case 8:
                                    case 14:
                                        echo '<a href="' . url::to('/my-order-detail/' . $order->order_code) . '">Đơn không hợp lệ</a>';
                                        break;
                                    default:
                                        echo 'Lỗi tình trạng';
                                }
